...
void *start_http_request(struct event_base* base,
        ...
        int id) {
    printf("start_http_request\n");
    struct http_request_get *http_req_get =
        (struct http_request_get *)http_request_new(base, url, req_get_flag, content_type, data, id);
